...
export default function ScrollMorphHero({ onScrollComplete, renderAuthContent }: ScrollMorphHeroProps) {
    ...
    useEffect(() => {
        const unsubscribe = virtualScroll.on("change", (value) => {
            if (value >= MAX_SCROLL * 0.9 && onScrollComplete && !scrollCompleteCalledRef.current) {
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                    ...
                    <motion.p
                        ...
                        className="mt-6 text-xs font-semibold tracking-[0.3em] text-gray-400 uppercase"
                    >
                        Scroll to Get Started
                    </motion.p>
                </div>

                {/* Auth Content (Fades in on scroll) */}
                <motion.div
